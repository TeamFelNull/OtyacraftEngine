...
public class TestCreativeTab {
    public static final CreativeTabRegistry.TabSupplier TEST_TAB = CreativeTabRegistry.create(new ResourceLocation(OtyacraftEngineTest.MODID, "test_tab"), () -> new ItemStack(Items.APPLE));
