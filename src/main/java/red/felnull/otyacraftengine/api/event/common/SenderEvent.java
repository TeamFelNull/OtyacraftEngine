...
public class SenderEvent extends Event {
    ...
    public SenderEvent(String uuid, ResourceLocation location, String name) {
        this.uuid = uuid;
    ...
    public static class Client extends SenderEvent {
        ...
        public static class Run extends ReceiverEvent.Client {
    ...
    public static class Server extends SenderEvent {
        ...
        public static class Run extends ReceiverEvent.Server {
            private final int all;
            private final int now;
