...
public class ClientDataSendMessage {
    ...
    public ClientDataSendMessage(String uuid, byte[] data) {
        this(uuid, new ResourceLocation("d:d"), "", data, 0, false);
    }

    public ClientDataSendMessage(String uuid, ResourceLocation location, String name, byte[] data, int size, boolean frist) {
        this.uuid = uuid;
