            ...
            'transformer': function (classNode) {
                ...
                for (m in methods) {
                    ...
                    if (method.name === "renderItemOverlayIntoGUI" || method.name === "func_180453_a") {
                        ...
                        // Method
                        var renderDurabilityMethod = new MethodInsnNode(Opcodes.INVOKESTATIC, "red/felnull/otyacraftengine/asm/hook/RenderHook", "renderItemOverlayIntoGUIHook", "(Lnet/minecraft/client/gui/FontRenderer;Lnet/minecraft/item/ItemStack;IILjava/lang/String;)V", false);
