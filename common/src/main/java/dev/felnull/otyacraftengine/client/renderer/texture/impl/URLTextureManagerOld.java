...
/*
public class URLTextureManagerOld {
    private static final URLTextureManagerOld INSTANCE = new URLTextureManagerOld();
    ...
    public static URLTextureManagerOld getInstance() {
        return INSTANCE;
    }
    ...
    private URLTextureLoadResult getAndLoadUrlTextureAsync(String url, boolean cached) {
